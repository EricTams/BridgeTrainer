...
/**
 * v2 convention rule-pack runner for NT Stayman/transfer family.
 * @param {Hand} hand
...
/** @deprecated Prefer getConventionRuleRecommendations. */
export const getNTStaymanTransferRuleRecommendations = getConventionRuleRecommendations;
